...
<html lang="en">
  ...
  <link rel="canonical" href="/edit-accounts">
  ...
  <div class="row">
    ...
    <div class="col-sm-12">
      <ul class="breadcrumb">
        ...
        <li><a  style="font-weight: bold " href="edit-updates">Updates</a></li>
    ...
    <div class="col-sm-8">
      <h1>Let you backes know about your updates</h1>
      <p>The date and time in which you edit the update, it will appear as that </p>
      ...
      <form>
        ...
        <div class="form-group light-blue">
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
                                <input class="form-control"  placeholder="New Update" id="example-search-input">
            </div>
          </div>
        </div>
