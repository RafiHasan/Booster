...
?>  
  <body>
                    ...
                    <form style='margin:0 auto; text-align:center;' action="http://sandbox.aamarpay.com/index.php" method="post" name="form1">
                    ...
                    <input type="hidden" name="signature_key" value="28c78bb1f45112f5d40b956fe104645e">
                    ...
                    <input type="hidden" name="success_url" value="pay/payment_success_page.php">
